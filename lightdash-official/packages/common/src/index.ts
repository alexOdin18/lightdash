...
export type FormatRowsOptions = { timezone?: string };
...
export function formatRawValue(
    ...
    if (isTimestamp && value !== null) {
        // Format in project timezone so calendar date (year/month/day) is correct.
        // Otherwise UTC conversion can shift the date (e.g. 2018-01-01 00:00 +0300 → 2017-12-31 21:00 UTC → wrong year).
